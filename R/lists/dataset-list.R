...
#'
DATASETS <- list(
  "united-kingdom" = Region$new(
    name = "united-kingdom", # leaving this as the default UK for historic purposes
  ...
  "united-kingdom-deaths" = Region$new(
    name = "united-kingdom-deaths",
    publication_metadata = PublicationMetadata$new(
  ...
  "united-kingdom-admissions" = Region$new(
    name = "united-kingdom-admissions",
    publication_metadata = PublicationMetadata$new(
  ...
  "regional-cases" = SuperRegion$new(
    name = "regional-cases",
    publication_metadata = PublicationMetadata$new(
  ...
  "regional-deaths" = SuperRegion$new(
    name = "regional-deaths",
    publication_metadata = PublicationMetadata$new(
  ...
  "test" = Region$new(
    ...
    stable = FALSE,
    case_modifier = function(cases) {
      return(generate_clean_cases(days_since_peak = 40))
    },
    publication_metadata = PublicationMetadata$new(
      title = "Test",
      description = "Null",
